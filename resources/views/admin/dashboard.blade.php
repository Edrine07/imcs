        ...
        <div class="col-xl-4">
            <a href="{{ route('appointment.new') }}" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                <div class="card-body">
                    ...
                    <div class="text-white fw-bolder fs-2 mb-2 mt-5">{{ $todayAppointments }}</div>
                        ...
                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                            <thead>
                                <tr class="fw-bolder text-muted">
                                    <th class="min-w-130px">Patient Id</th>
                                    <th class="min-w-130px">Patient Name</th>
                                    <th class="min-w-130px">Address</th>
                                    <th class="min-w-130px">Contact No.</th>
