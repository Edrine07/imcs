...
<header class="absolute top-0 left-0 w-full z-50 px-4 lg:px-10 xl:px-30 2xl:px-44">
    ...
    <div class="flex flex-wrap items-center justify-between py-6">
        <div class="w-1/2 md:w-auto">
            <h1 href="index.html" class="italic font-light font-serif md:text-violet-400 text-4xl text-poppins">
        ...
        <div class="hidden md:flex w-full md:w-auto" id="menu">
            <nav
                ...
                <ul class="md:flex items-center font-poppins">
                    <li class="md:ml-4"><a class="py-2 inline-block md:text-black-100 md:px-2 font-semibold"
                            href="#home" class="nav__link">Home</a></li>
                    <li class="md:ml-4"><a class="py-2 inline-block md:text-black-100 md:px-2 font-semibold"
                            href="#about" class="nav__link">About</a></li>
                    <li class="md:ml-4 "><a class="py-2 inline-block md:text-black-100 md:px-2 font-semibold"
                            href="#service" class="nav__link">Service</a></li>
                    <li class="md:ml-4 "><a class="py-2 inline-block md:text-black-100 md:px-2 font-semibold"
                            href="#blog" class="nav__link">Blogs</a></li>
        ...
        <section
            ...
            <div class="lg:w-3/4 xl:w-2/4 relative z-8 h-50 lg:mt-9">
                <div>
                    ...
                    <p class="italic text-black-100 text-xl md:text-2xl leading-snug mt-4">As your trusted healthcare
    ...
    <section class="bg-blue-100 px-4 py-16 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 lg:py-32">
        <div class="flex flex-col lg:flex-row lg:-mx-8">
            <div class="w-full lg:w-1/2 lg:px-8">
                ...
                <p class="mt-2 leading-relaxed text-justify">The Medical Clinic of Dr. Carpio, a distinguished physician
                    ...
                    with a vision of promoting well-being and offering comprehensive medical services under one roof.
                </p>
            </div>
            ...
            <div class=" md:flex md:flex-wrap mt-8 text-center md:-mx-4 ">
                ...
                <div class="md:w-1/2 md:px-4 mt-4 md:mt-0 lg:w-1/4">
                    <div class="bg-white rounded-lg border border-gray-300 p-8">
                        ...
                        <h4 class="text-xl font-bold mt-4">Specialized Care (e.g., Cardiology, Orthopedics, Gynecology)
                        </h4>
                        <p class="mt-1">Let us show you how our experience.</p>
                        <a href="#" class="block mt-4">Read More</a>
                    </div>
        ...
        <section class="blog section" id="blog">
            ...
            <section
                ...
                <div class="md:flex md:items-center md:justify-center">
                    <h2 class="text-xl font-bold text-white">Get in touch with us today! <br
                            class="block md:hidden">Call us on: +639192771777</h2>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                        ...
                        <ul class="mt-4">
                            ...
                            <li class="mt-2"><a href="#" title=""
                                    class="opacity-75 hover:opacity-100">Wound Care</a></li>
                            <li class="mt-2"><a href="#" title=""
                                    class="opacity-75 hover:opacity-100">Primary Care</a></li>
                            <li class="mt-2"><a href="#" title=""
